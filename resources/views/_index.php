        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="#" class="nav-item nav-link">Tentang Krenova</a>
                    <a href="#" class="nav-item nav-link">Inovasi</a>
                    <a href="#" class="nav-item nav-link">Juri</a>
                    <a href="#" class="nav-item nav-link">Testimonial</a>
                    <a href="#" class="nav-item nav-link">Kontak</a>
                </div>
                <a href="{{ config('app.login') }}" target="_blank" class="btn btn-primary py-2 px-4 ms-3">Masuk /
                    Daftar</a>
            </div>
        </nav>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="{{ config('app.login') }}" target="_blank"
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h5 class="fw-bold text-primary text-uppercase">eKrenova - oleh BAPPEDA SALATIGA</h5>
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="#"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>Tentang Krenova</a>
                                <a class="text-light mb-2" href="#"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>Inovasi</a>
                                <a class="text-light mb-2" href="#"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>Juri</a>
                                <a class="text-light mb-2" href="#"><i
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                <a class="text-light mb-2" href="http://bappeda.salatiga.go.id"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>bappeda.salatiga.go.id</a>
                                <a class="text-light mb-2" href="http://salatiga.go.id"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>salatiga.go.id</a>
                                <a class="text-light mb-2" href="http://jatengprov.go.id"><i
                                        class="bi bi-arrow-right text-primary me-2"></i>jatengprov.go.id</a>
                                <a class="text-light mb-2" href="https://pindah.jatengprov.go.id"><i
